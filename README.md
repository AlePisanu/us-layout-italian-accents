...
Press `Alt + ` ` (backtick), release both keys, then press a vowel to get the accented version. The script waits up to 2 seconds for the next key. If no key is pressed, it outputs a literal backtick.
